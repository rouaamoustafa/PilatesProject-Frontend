...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#fafaf8] pt-16 pb-8 px-4 sm:px-8 border-t border-gray-200 mt-12">
      {/* Newsletter */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-10">
        <div>
          <h3 className="text-2xl font-semibold text-[#2e372c] mb-4 tracking-widest">NEWSLETTER</h3>
          <form
            onSubmit={handleNewsletterSubmit}
            className="flex flex-col sm:flex-row border-b border-[#2e372c] max-w-xl"
          >
            <input
              type="email"
            ...
            <button
              type="submit"
              className="py-3 px-2 text-[#2e372c] hover:text-[#4b5941] transition w-full sm:w-auto"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-[#2e372c]">
              <li>
                <a href="/book" className="relative inline-block group">
              ...
              <li>
                <a href="/joinInstructor" className="relative inline-block group">
                  <span className="transition-colors duration-500">Instructors</span>
                  <span className="absolute left-0 -bottom-0.5 w-0 h-[0.7px] bg-[#2e372c] transition-all duration-300 group-hover:w-full" />
                </a>
              </li>
              <li>
                <a href="/subscribe" className="relative inline-block group">
                  <span className="transition-colors duration-500">Pilates Studio</span>
                  <span className="absolute left-0 -bottom-0.5 w-0 h-[0.7px] bg-[#2e372c] transition-all duration-300 group-hover:w-full" />
                </a>
              </li>
            </ul>
      ...
      {/* Bottom row */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between border-t border-gray-200 pt-6 gap-4 md:gap-6">
        {/* Logo */}
        <div className="font-serif text-3xl sm:text-5xl md:text-[2.5vw] min-w-[180px] tracking-widest text-[#3E4939] select-none mb-2 md:mb-0">
          Pilates
        </div>
        {/* Social small icons + copyright */}
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          <div className="flex items-center gap-2">
            <a
              ...
              className="bg-gray-200 rounded-full px-4 py-2 text-[#3E4939] font-semibold text-lg transition-transform duration-500 hover:scale-110 cursor-pointer select-none"
            >
              IG
            </a>
            <a
          ...
          <span className="text-gray-600 text-sm text-center">&copy; 2025 Rouaa Moustafa, All Rights Reserved</span>
        </div>
      </div>
    </footer>
  )
